...
class SharedRemoteProcedureTaskState(
    GoldUnitSharedState, ScreenTaskSharedState, OnboardingSharedState, SharedTaskState
):
...
class RemoteProcedureBlueprintArgs(
    UseGoldUnitArgs, ScreenTaskRequiredArgs, OnboardingRequiredArgs, BlueprintArgs
):
...
class RemoteProcedureBlueprint(
    UseGoldUnit, ScreenTaskRequired, OnboardingRequired, Blueprint
):
